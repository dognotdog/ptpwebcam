...
- (NSArray*) parsePtpRangeEnumData: (NSData*) data ofType: (int) dataType remainingData: (NSData** _Nullable) remData; // override in subclasses where enum range is non-conforming (looking at you, Canon)
